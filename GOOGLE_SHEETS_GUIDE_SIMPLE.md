# 📊 Configuration Google Sheets - Guide simplifié
...
## 🔑 ÉTAPE 2 : Google Cloud Console (5 min)
...
5. **Une nouvelle ligne devrait apparaître** avec vos données, y compris la commune dans la colonne D !

---

## ✅ Checklist finale

- [ ] Google Sheet créé avec les 5 en-têtes (Date/Heure, Prénom, Email, Commune, Code coupon)
- [ ] ID du Sheet noté
...
**Exemples :**
- "J'ai créé le Sheet, voici l'ID : 1ABC123..."
- "Je suis dans Google Cloud, je fais quoi maintenant ?"
- "J'ai le fichier JSON, comment le mettre dans Vercel ?"
